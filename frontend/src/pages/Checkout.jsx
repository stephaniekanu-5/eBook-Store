...
export default function Checkout() {
  ...
  const handleSuccess = async (response) => {
    try {
      ...
      if (result.success) {
        addPurchase(result.purchases?.length ? result.purchases : cart);
  ...
  return (
    <main className="min-h-screen bg-black text-white px-4 py-10">
        ...
        <section className="bg-gradient-to-b from-gray-900 to-black border border-white/10 rounded-3xl p-8 shadow-2xl h-fit sticky top-8">
          ...
          <div className="bg-white/5 border border-white/10 rounded-3xl p-5 mb-8">
            <div className="flex items-center gap-2 mb-4">
              ...
              <h3 className="font-bold">Discount Coupon</h3>
            </div>
            <div className="flex flex-col sm:flex-row gap-3 w-full">
              <input
                ...
                className="w-full sm:flex-1 min-w-0 rounded-2xl bg-black/40 border border-white/10 px-4 py-3 outline-none focus:border-yellow-400"
              />

              <button
                onClick={applyCoupon}
                disabled={loadingCoupon}
                className="w-full sm:w-auto bg-yellow-400 hover:bg-yellow-300 text-black font-bold px-5 py-3 rounded-2xl transition disabled:opacity-60"
              >
                {loadingCoupon ? "..." : "Apply"}
              </button>
            </div>
          ...
          <div className="mt-8 rounded-3xl bg-green-500/10 border border-green-500/20 p-5">
            <div className="flex items-center gap-3 mb-4">
              ...
              <h3 className="font-bold">Protected Checkout</h3>
            </div>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-8">
          <div className="bg-gray-900 rounded-3xl border border-white/10 p-8 hover:border-yellow-400 transition">
            ...
            <p className="text-gray-400 leading-relaxed">
              Every payment is securely processed through Paystack using
          ...
          <div className="bg-gray-900 rounded-3xl border border-white/10 p-8 hover:border-yellow-400 transition">
            ...
            <p className="text-gray-400 leading-relaxed">
              Purchased ebooks become available immediately after successful
              payment.
            </p>
          </div>
          ...
          <div className="bg-gray-900 rounded-3xl border border-white/10 p-8 hover:border-yellow-400 transition">
            ...
            <h3 className="font-bold text-xl mb-3">Premium Collection</h3>
          ...
          <div className="bg-gray-900 rounded-3xl border border-white/10 p-8 hover:border-yellow-400 transition">
            ...
            <h3 className="font-bold text-xl mb-3">Trusted Support</h3>
      ...
      <section className="max-w-6xl mx-auto mt-20">
        ...
        <FeaturedTitle title="" books={cart.slice(0, 4)} />
      </section>
    </main>
  );
}
